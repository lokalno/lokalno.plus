...
import { DEFAULT_RULES, DEFAULT_PRIVACY } from "../src/lib/moderation";
import { CATALOG, CATALOG_COUNT, listingPhotos } from "./catalog-data";
...
async function main() {
  ...
  console.log(`Added ${CATALOG_COUNT} listings (10 per category, 12 categories).`);
  console.log("Admin:  admin@lokalno.ua / admin123");
  console.log("Demo:   demo@lokalno.ua / demo1234");
  console.log("Seller: seller1@lokalno.ua / seller1234 (also seller2-4)");
}
