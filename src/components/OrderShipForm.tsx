...
import { getNovaPoshtaTrackingUrl, NOVA_POST_BRAND } from "@/lib/nova-poshta-links";
...
export default function OrderShipForm({
  ...
  return (
    ...
    <div className="mt-3 space-y-3">
      ...
      <NovaPoshtaSellerGuide codAmount={codAmount} compact />



      {showDeliveryAddress && deliveryLines.length > 0 && (

        <div className="rounded-lg border border-violet-100 bg-white p-3 text-xs text-gray-700">
      ...
      <form onSubmit={handleSubmit} className="rounded-xl border border-violet-200 bg-violet-50/70 p-3 space-y-2">

        <p className="text-sm font-semibold text-violet-950">Номер ТТН після відправки</p>
