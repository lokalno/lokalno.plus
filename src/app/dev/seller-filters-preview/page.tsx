...
/** Локальний preview фільтрів продавця (без БД). Доступ лише в development. */
export default function SellerFiltersPreviewPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-3 py-6 sm:px-4 sm:py-8">
      <div className="mb-6 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
        Dev preview: mock-дані продавця для перевірки UI фільтрів (без БД).
      </div>
      <section>
        ...
        <SellerListingsCatalog listings={listings} />
      </section>
    </div>
  );
}
